...
database = '../highperformanceData/Orl_shelter_40_percent_60_sigma_sqrt10/Orl_shelter_40_percent_60.mat'  ;  
basestr = '../highperformanceData/Orl_shelter_40_percent_60_sigma_sqrt10/Orl_shelter_40_percent_60allbest' ;
basestr2 = 'Orl_shelter_40_percent_60_sigma_sqrt10allbest';
load(database);
%{
input variables: 

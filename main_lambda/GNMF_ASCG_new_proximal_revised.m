function [H, W, G] = GNMF_ASCG_new_proximal_revised(V,Winit,Hinit,L,lambda,tol,maxiter)
...
for iter=1:maxiter,
    ...
    G.V_fval=[G.V_fval;fval];
    fvalcri = abs(G.V_fval(iter)-G.V_fval(iter+1))/G.V_fval(iter);

...
datafilebasestr = 'YaleB_shelter_10_percent_%dallbestfinal1to13';
outfiledir = 'fig';
outfilename = 'YaleB_shelter_10_percent_aver_kallbest.eps';
...
i = 1;
load(fullfile(datadir,'YaleBfinal1to13.mat'),'AccuracyN_ASCG','AccuracyG_ASCG','AccuracyGd_ASCG');
...
i = i + 1;
load(fullfile(datadir,'YaleB10final1to13.mat'),'AccuracyN_ASCG','AccuracyG_ASCG','AccuracyGd_ASCG');
AccuracyN_ASCG_aver(i) = mean(AccuracyN_ASCG);
AccuracyG_ASCG_aver(i) = mean(AccuracyG_ASCG);
AccuracyGd_ASCG_aver(i) = mean(AccuracyGd_ASCG);

% copy this file to ../Accuracy
% need Accuracy.m rd.m
% for highperformance result on 17_7_??
...
database = '../highperformanceData/YaleB_shelter_10_percent_80_sigma_sqrt10/YaleB_c_shelter_10_percent_80.mat'  ;  
basestr = '../highperformanceData/YaleB_shelter_10_percent_80_sigma_sqrt10/YaleB_shelter_10_percent_80allbest' ;
basestr2 = 'YaleB_shelter_10_percent_80allbest';
load(database);
%{
input variables: 
...
% save file
save([basestr2,'final7to',num2str(knum),'.mat'],...
